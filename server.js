...
client.on("message", msg => {
  if (msg.content === "رابط البوت") {
    msg.reply(
      "**https://discord.com/api/oauth2/authorize?client_id=755772952431034438&permissions=8&scope=bot**"
    );
  }
});

client.on("message", msg => {
  if (msg.content === "سيرفر البوت") {
    msg.reply("**https://discord.gg/AytEDu**");
  }
});
...
client.on("message", msg => {
  if (msg.content === "brbا") {
    msg.reply("**بس لاتطول TyT :heart: **");
  }
});

client.on("message", msg => {
  if (msg.content === "مصمم البوت") {
    msg.reply("** Glitch Owner GlitchStore:heart: **");
  }
});
...
client.on("guildCreate", guild => {
  var embed = new Discord.RichEmbed()
    .setColor(0x5500ff)
    .setDescription(`**https://discord.gg/Cn6u35q لاتنسى دخول سيرفر الدعم **`);
  guild.owner.send(embed);
});
...
client.login("NzU1NzcyOTUyNDMxMDM0NDM4.X2IKaQ.BgR2geJ8RFws2JiYblFPek_Fevw");
...
client.on('ready', () => {
   console.log(`----------------`);
    ...
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`Glitch من صنع`,"http://twitch.tv/S-F") /// تعديل مهم حط بدل هلو حالة البوت
